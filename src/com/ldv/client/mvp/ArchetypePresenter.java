 ...
 * 
 */
public abstract class ArchetypePresenter<D extends ArchetypePresenter.DisplayModel> extends WidgetPresenter<D> 
{
	...
	protected final LdvArchetype      _archetype ;
	protected final LdvModelNodeArray _patpatho ;
	
	protected       boolean           _bAvailablePseudo ; 
	
	public ArchetypePresenter(final D             display, 
	...
	private void checkPseudoAvailability(String pseudo)
	{	
		_dispatcher.execute(new LdvCheckPseudoAction(pseudo), new PseudoAvailabilityCallback()) ;
	}
	
	protected class PseudoAvailabilityCallback implements AsyncCallback<LdvCheckPseudoResult> 
	{
		...
		@Override
		public void onSuccess(LdvCheckPseudoResult value) 
		{

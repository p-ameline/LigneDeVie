...
/*private static final String SERVER_ERROR = "An error occurred while "
	...
	*/
	...
	protected void onBind() 
	{
		eventBus.addHandler(BackToWelcomePageEvent.TYPE, new BackToWelcomePageEventHandler() {
			...
			{
				Log.info("LdvMainPresenter: Back to welcome page") ;
				doLoad() ;	
			}
		});
		...
		eventBus.addHandler(GoToLdvRegisterPageEvent.TYPE, new GoToLdvRegisterPageEventHandler() 
		{
			...
			{
				Log.info("LdvMainPresenter: Call to go to post login page") ;
				goToRegisterPage() ;	
			}
		});
		...
		eventBus.addHandler(GoToLdvManagerEvent.TYPE, new GoToLdvManagerEventHandler() 
		{
			...
			{
				Log.info("LdvMainPresenter: Call to go to manager page") ;
				goToManagementPage() ;
			}
		});
		...
		eventBus.addHandler(GoToLdvMainEvent.TYPE, new GoToLdvMainEventHandler() 
		{
			...
			{
				Log.info("LdvMainPresenter: Call to go to main page") ;
				openMainLdvPage() ;
			}
		});
		...
		eventBus.addHandler(GoToLdvAgendaEvent.TYPE, new GoToLdvAgendaEventHandler() 
		{
			...
			{
				Log.info("LdvMainPresenter: Call to go to agenda page") ;
				openAgendaPage() ;
			}
		});
		...
		Window.addResizeHandler(new ResizeHandler()
		{
			...
			{
				Log.info("LdvMainPresenter: Call to resize workspace") ;
   ...
   */
	public void doLoad()
	{
		Log.info("LdvMainPresenter: Calling doLoad");
	...
	{
		Log.info("LdvMainPresenter: Going to management page") ;
		display.getWorkspace().clear() ;
	...
	{
		Log.info("LdvMainPresenter: Going to main Ldv page") ;
		display.getWorkspace().clear() ;
	...
	{
		Log.info("LdvMainPresenter: Going to agenda page") ;
		display.getWorkspace().clear() ;
	...
	{
		Log.info("LdvMainPresenter: Going to register page") ;
		display.getWorkspace().clear() ;
	...
	public void goToValidatingPage(final String sFutureId)
	{
		...
		Log.info("LdvMainPresenter: Going to validating page") ;
		display.getWorkspace().clear() ;

 ...
 * </ul>
 */
public class LdvSliderBar extends FocusPanel implements RequiresResize, HasValue<Double>,
  ...
  public static interface LabelFormatter {
     ...
     */
    String formatLabel(LdvSliderBar slider, double value);
  }
   ...
   */
  public LdvSliderBar(double minValue, double maxValue) {
   ...
   */
  public LdvSliderBar(double minValue, double maxValue, LabelFormatter labelFormatter) {
    this(minValue, maxValue, labelFormatter, LdvResources.INSTANCE);
  }
   ...
   */
  public LdvSliderBar(double minValue, double maxValue, LabelFormatter labelFormatter, LdvResources images) 
  {
    super();

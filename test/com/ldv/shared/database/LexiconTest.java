...
public class LexiconTest extends TestCase
{
  ...
  public void testLabelFunctions() 
  {
  	...
  	assertTrue(lexicon2.getSelectionLabel().equals("Butler (lenticône interne)")) ;
  	...
  	assertTrue(lexicon3.getSelectionLabel().equals("caillot adhérent {lors d'une hémorragie}")) ;
  }
